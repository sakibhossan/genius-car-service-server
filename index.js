...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.wnhxcgw.mongodb.net/?retryWrites=true&w=majority`;
    ...
    try {
        ...
        app.get('/order', verifyJWT, async (req, res) => {
            ...
            if (email === decodedEmail) {
                ...
                res.status(403).send({message: 'forbidden accees'})
            }
